...
if(isset($_POST['submit']))
{
	...
	$b = $_POST['Email'];
	$c = $_POST['Message'];
	$q = mysqli_query($conn,"insert into feedback values(NULL,'$a','$b','$c')");
	if($q)
	{
			...
			<div class="contact-agileitsinfo">
				...
				<div class="col-md-4 contact-grids">
					<div class="cnt-address">
						...
						<h4>Get In Touch</h4>
						<p>Prabin kandel: +977 98400 00001 <br>
							<span>Sundar Mani poudel: +977 9800000001 </span>
							E-mail: <a href="mailto:info@example.com">info@milantraevents.np</a>
						</p>
					</div>
				</div>
